...
const renderPaginationBtns = (onClick,page,lastPage) => {
    ...
    const middleBtn = ['....'];
    const lastBtn =[lastPage -3,lastPage -2,lastPage -1];

    let btnsArr = [];

    if(page < lastPage -6) {
        btnsArr = [...startBtns,...middleBtn,...lastBtn]
    }else if(page < lastPage -4) {
        btnsArr = [...gapBtns,...middleBtn,...lastBtn]
    }else if (page < lastPage -3) {
        btnsArr = [...startBtns,...lastBtn]
    }else{
        btnsArr = [...middleBtn,...lastBtn]
    }
